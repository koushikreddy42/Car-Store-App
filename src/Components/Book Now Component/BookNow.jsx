        ...
        <div className={styles.container}>
            ...
            <div className={styles.addtext}>
                ...
                <button className={styles.tdrive}>
                    Book Test Drive <i className="fa-regular fa-calendar"></i>
                </button>
            </div>
            <div className={styles.additionalDetails}>
                ...
                <div className={styles.desc}>
                    ...
                    <p className={styles.descPara}>
                        Safety is the most important part of the overall Model 3 design. The metal structure is a combination of aluminum and steel, for maximum strength in every area. In a roof-crush test, Model 3 resisted four times its own mass, even with an all-glass roof.
                    </p>
                </div>
                <hr className={styles.endline} />
                <div className={styles.desc}>
            ...
            <div className={styles.feat}>
                <div className={styles.box1}>
                    <a><i className="fa-solid fa-stopwatch"></i></a>
                ...
                <div className={styles.box2}>
                    <a><i className="fa-solid fa-gauge-simple-high"></i></a>
                    <div className={styles.midbox}>
                ...
                <div className={styles.box3}>
                    <a><i className="fa-solid fa-gas-pump"></i></a>
                    <div className={styles.midbox}>
            ...
            <div className={styles.keyfeat}>
                ...
                <div className={styles.feats}>
                    <div className={styles.icontxt}>
                        <a><i className="fa-solid fa-spray-can"></i></a>
                        <p>Solid Black Paint</p>
                    </div>
                    <div className={styles.icontxt}>
                        <a><i className="fa-solid fa-couch"></i></a>
                        <p>Black Premium Interior</p>
                    </div>
                    <div className={styles.icontxt}>
                        <a><i className="fa-solid fa-circle-radiation"></i></a>
                        <p>Autopilot</p>
                    </div>
                    <div className={styles.icontxt}>
                        <a><i className="fa-solid fa-wifi"></i></a>
            ...
            <div className={styles.orderopen}><PlaceOrder className={styles.orderopen} isOpen={isPlaceOrderOpen} onClose={closePlaceOrder} /></div>
