            ...
            <div className={styles.modalContent}>
              <div className={styles.modalHeader}>
                <div className={styles.modalheads}>
                  <h3 className={styles.modalTitle} id="exampleModalLabel">
                    Vehicle Order Form
                  </h3>
                  <p>
                    Please fill in the form below to proceed. Thank you for
              ...
              <div className={styles.modalBody}>
                ...
                <div className={styles.textline}>
                  <p>
                    * Please upload a merged document containing your 'ID
                    Proof', 'Driver's License' and 'Address Proof'.
                  </p>
                </div>
                <div className={styles.formGroup}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <textarea
                    className={styles.formControl4}
                    id="comments"
                    placeholder="Enter any additional requests or comments"
                    onChange={handleInputChange}
                  />
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.form_label}>
                    ...
                    I confirm that I have reviewed my order and agree to the
              ...
              <div className={styles.modalFooter}>
                ...
                {/*className={`${styles.btn} ${isChecked ? styles.btnPrimary : styles.btnSecondary}`} disabled={!isChecked} */}
              </div>
            </div>
          </form>
        </div>
