  ...
  const toggleFavorite = async () => {
    try {
      if (isFavorite) {
        ...
        await axios.post('http://localhost:8080/api/add-favourite', { carId: car._id, carType: 'electriccarmodel' }, {
          headers: {
            'x-token': token
          }
        });
     ...
     <div className={styles.col_sm}>
      ...
      <div className={styles.feat}>
        ...
        <div className={styles.box3}>
          ...
          <div className={styles.midbox}>
            <p className={styles.num}>{car.range}</p>
  ...
  <AiOutlineHeart color="#333" size={30} />
      ...
      <div className={styles.additionalDetails}>
          ...
          <div className={styles.desc}>
            ...
            <p className={styles.descPara}>{car.rangedescription}</p>
          </div>
      </div>
     </div>
     ...
     <PlaceOrder isOpen={isPlaceOrderOpen} onClose={closePlaceOrder} carType="ev" buyerId={data._id} carId={car._id} isAdmin={car.isAdmin} buyerEmail={data.email}/>
     </>) : (
