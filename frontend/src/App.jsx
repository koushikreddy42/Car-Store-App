      ...
      <store.Provider value={[token, setToken, adminToken, setAdminToken]}>
        <Router>
          <Routes>
            ...
            <Route
              exact
              path="/book-now/:param1/:param2"
              element={<BookNow />}
            />
            <Route
              exact
              path="/electric-booking/:param1/:param2/:param3"
              element={<EvsBooking />}
            />
            <Route
              exact
              path="/gas-booking/:param1/:param2/:param3"
              element={<GasBooking />}
            />
